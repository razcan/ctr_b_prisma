...
COPY public."ContractFinancialDetail" (id, "updateadAt", "createdAt", itemid, currencyid, "currencyValue", "currencyPercent", "billingDay", "billingQtty", "billingFrequencyid", "measuringUnitid", "paymentTypeid", "billingPenaltyPercent", "billingDueDays", remarks, "guaranteeLetter", "guaranteeLetterCurrencyid", "guaranteeLetterDate", "guaranteeLetterValue", "contractItemId", active, "goodexecutionLetter", "goodexecutionLetterBankId", "goodexecutionLetterCurrencyId", "goodexecutionLetterDate", "goodexecutionLetterInfo", "goodexecutionLetterValue", "guaranteeLetterBankId", "guaranteeLetterInfo", price, "advancePercent") FROM stdin;
\.
...
SELECT pg_catalog.setval('public."AlertsHistory_id_seq"', 144, true);
...
SELECT pg_catalog.setval('public."ContractAlertSchedule_id_seq"', 98, true);
...
SELECT pg_catalog.setval('public."ContractAttachments_id_seq"', 10, true);
...
SELECT pg_catalog.setval('public."ContractDynamicFields_id_seq"', 49, true);
...
SELECT pg_catalog.setval('public."ContractFinancialDetailSchedule_id_seq"', 196, true);
...
SELECT pg_catalog.setval('public."ContractFinancialDetail_id_seq"', 17, true);
...
SELECT pg_catalog.setval('public."ContractItems_id_seq"', 20, true);
...
SELECT pg_catalog.setval('public."ContractsAudit_auditid_seq"', 193, true);
...
SELECT pg_catalog.setval('public."Contracts_id_seq"', 63, true);
...
SELECT pg_catalog.setval('public."ExchangeRates_id_seq"', 736, true);
