...
SELECT pg_catalog.setval('public."ContractAlertSchedule_id_seq"', 100, true);
...
SELECT pg_catalog.setval('public."ContractAttachments_id_seq"', 11, true);
...
SELECT pg_catalog.setval('public."ContractContent_id_seq"', 8, true);
...
SELECT pg_catalog.setval('public."ContractDynamicFields_id_seq"', 50, true);
...
SELECT pg_catalog.setval('public."ContractFinancialDetailSchedule_id_seq"', 201, true);
...
SELECT pg_catalog.setval('public."ContractFinancialDetail_id_seq"', 47, true);
...
SELECT pg_catalog.setval('public."ContractItems_id_seq"', 82, true);
...
SELECT pg_catalog.setval('public."ContractTasks_id_seq"', 54, true);
...
SELECT pg_catalog.setval('public."ContractsAudit_auditid_seq"', 194, true);
...
SELECT pg_catalog.setval('public."Contracts_id_seq"', 64, true);
...
SELECT pg_catalog.setval('public."ExchangeRates_id_seq"', 768, true);
...
SELECT pg_catalog.setval('public."WorkFlowContractTasks_id_seq"', 897, true);
...
SELECT pg_catalog.setval('public."WorkFlowXContracts_id_seq"', 730, true);
