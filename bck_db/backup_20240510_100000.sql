...
SELECT pg_catalog.setval('public."AlertsHistory_id_seq"', 230, true);
...
SELECT pg_catalog.setval('public."ContractAlertSchedule_id_seq"', 108, true);
...
SELECT pg_catalog.setval('public."ContractContent_id_seq"', 12, true);
...
SELECT pg_catalog.setval('public."ContractDynamicFields_id_seq"', 54, true);
...
SELECT pg_catalog.setval('public."ContractTasks_id_seq"', 58, true);
...
SELECT pg_catalog.setval('public."ContractsAudit_auditid_seq"', 202, true);
...
SELECT pg_catalog.setval('public."Contracts_id_seq"', 68, true);
...
SELECT pg_catalog.setval('public."ExchangeRates_id_seq"', 832, true);
...
SELECT pg_catalog.setval('public."WorkFlowContractTasks_id_seq"', 901, true);
...
SELECT pg_catalog.setval('public."WorkFlowXContracts_id_seq"', 733, true);
