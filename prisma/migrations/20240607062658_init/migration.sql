/*
  ...
  - You are about to drop the `Invoice2` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "Invoice2" DROP CONSTRAINT "Invoice2_currencyId_fkey";

-- DropForeignKey
ALTER TABLE "Invoice2" DROP CONSTRAINT "Invoice2_entityId_fkey";

-- DropForeignKey
ALTER TABLE "Invoice2" DROP CONSTRAINT "Invoice2_entitybankId_fkey";

-- DropForeignKey
ALTER TABLE "Invoice2" DROP CONSTRAINT "Invoice2_partnerId_fkey";

-- DropForeignKey
ALTER TABLE "Invoice2" DROP CONSTRAINT "Invoice2_partneraddressId_fkey";

-- DropForeignKey
ALTER TABLE "Invoice2" DROP CONSTRAINT "Invoice2_seriesId_fkey";

-- DropForeignKey
ALTER TABLE "Invoice2" DROP CONSTRAINT "Invoice2_statusId_fkey";

-- DropForeignKey
ALTER TABLE "Invoice2" DROP CONSTRAINT "Invoice2_transactionTypeId_fkey";

-- DropForeignKey
ALTER TABLE "Invoice2" DROP CONSTRAINT "Invoice2_typeId_fkey";

-- DropForeignKey
ALTER TABLE "Invoice2" DROP CONSTRAINT "Invoice2_userId_fkey";
